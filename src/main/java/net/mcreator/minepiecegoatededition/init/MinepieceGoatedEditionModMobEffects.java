...
import net.mcreator.minepiecegoatededition.potion.MagnetismMobEffect;
import net.mcreator.minepiecegoatededition.potion.GravityMobEffect;
import net.mcreator.minepiecegoatededition.potion.BouncyMobEffect;
...
public class MinepieceGoatedEditionModMobEffects {
	...
	public static final RegistryObject<Effect> MAGNETISM = REGISTRY.register("magnetism", () -> new MagnetismMobEffect());
	public static final RegistryObject<Effect> BOUNCY = REGISTRY.register("bouncy", () -> new BouncyMobEffect());
}
